...
- [Browser privacy evidence](browser-privacy-evidence.md) — rendered-browser account tests must separate disposable GIS stubs from real Google OAuth claims and record only redacted labels, dates, and keys
